...
export const HOME_COPY = {
    en: {
        ...
        publicPresenceOn: 'Your live presence is visible to other members.',
        publicPresenceOff: 'Your live presence is hidden until you choose to join.',
        enablePublicPresence: 'Show me in the study room',
        disablePublicPresence: 'Hide my presence',
        ...
        smartSuggestionMessages: {
            new: 'Add your first course to get personalized study suggestions.',
            neglected: "You haven't studied {course} in {days} days. Maybe review it today?",
            progress: 'You are close to finishing the {course} roadmap. Study now to complete it!',
            general: 'Plan a quick focus session for {course} today.',
        },
        trLabel: 'Türkçe',
        enLabel: 'English',
        widgetNames: {
            ...
            'global-study-room': 'Global Study Room',
    ...
    tr: {
        ...
        publicPresenceOn: 'Canlı görünürlüğün diğer üyelere açık.',
        publicPresenceOff: 'Sen açana kadar canlı görünürlüğün gizli kalır.',
        enablePublicPresence: 'Beni çalışma odasında göster',
        disablePublicPresence: 'Görünürlüğümü gizle',
        ...
        motivationSubtitle: '{name} · {description}',
        smartSuggestionMessages: {
            new: 'Kişisel çalışma önerileri almak için ilk dersini ekle.',
            neglected: '{course} dersine {days} gündür dönmedin. Bugün kısa bir tekrar iyi gelebilir.',
            progress: '{course} yol haritasını bitirmene az kaldı. Bugün çalışıp tamamlamaya yaklaşabilirsin.',
            general: 'Bugün {course} için kısa bir odak oturumu planla.',
        },
        trLabel: 'Türkçe',
        enLabel: 'İngilizce',
        widgetNames: {
            ...
            'global-study-room': 'Ortak çalışma odası',
