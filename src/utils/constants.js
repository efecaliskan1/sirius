export const THEMES = [
    {
        key: 'calm',
        name: 'Default Calm',
        description: 'Warm cream paper with sticker accents',
        preview: ['#F5EFE4', '#FCD34D', '#A8D4F0'],
        vars: {
            // Legacy color tokens (kept for inline styles still using them)
            '--color-surface': '#F5EFE4',
            '--color-surface-card': '#FAF6ED',
            '--color-surface-hover': '#F0E9DA',
            '--color-surface-dark': '#EFE7D5',
            '--color-border': '#1A1A1A',
    ...
    },
    {
        key: 'dark',
        name: 'Focus Dark',
        description: 'Inky midnight paper with cream outlines',
        preview: ['#0F172A', '#FCD34D', '#F5EFE4'],
        vars: {
            ...
            '--color-border': '#F5EFE4',
            '--color-border-light': '#F5EFE4',
            '--color-text': '#F5EFE4',
            '--color-text-secondary': '#CBD5E1',
            '--color-text-muted': '#94A3B8',
            '--color-sidebar': '#1E293B',
            '--color-primary': '#FCD34D',
            '--color-primary-bg': 'rgba(252, 211, 77, 0.18)',
            '--sidebar-bg': '#1E293B',
            '--sidebar-border': '#F5EFE4',
            // Brutalist tokens — dark variant
            '--bb-ink': '#F5EFE4',
            '--bb-paper': '#0F172A',
            '--bb-card': '#1E293B',
            '--bb-shadow': '#FCD34D',
    ...
    },
    {
        key: 'nature',
        name: 'Nature',
        description: 'Sage paper with leaf-green stickers',
        preview: ['#E8F0E1', '#16A34A', '#FDE68A'],
        vars: {
            '--color-surface': '#E8F0E1',
            '--color-surface-card': '#F5F8EE',
            '--color-surface-hover': '#DEE8D2',
            '--color-surface-dark': '#D5E1C5',
            '--color-border': '#1A2E13',
            '--color-border-light': '#1A2E13',
            '--color-text': '#1A2E13',
            '--color-text-secondary': '#3D5C2D',
            '--color-text-muted': '#6B8454',
            '--color-sidebar': '#F5F8EE',
            '--color-primary': '#1A2E13',
            '--color-primary-bg': '#86EFAC',
            '--sidebar-bg': '#F5F8EE',
            '--sidebar-border': '#1A2E13',
            // Brutalist
            '--bb-ink': '#1A2E13',
            '--bb-paper': '#E8F0E1',
            '--bb-card': '#F5F8EE',
    ...
    },
    {
        key: 'latte',
        name: 'Coffee Latte',
        description: 'Warm beige paper with caramel stickers',
        preview: ['#F5E6CC', '#D97706', '#FCD34D'],
        vars: {
            '--color-surface': '#F5E6CC',
            '--color-surface-card': '#FAF1DC',
            '--color-surface-hover': '#EFDCB8',
            '--color-surface-dark': '#E8D2A0',
            '--color-border': '#3D2914',
            '--color-border-light': '#3D2914',
            '--color-text': '#3D2914',
            '--color-text-secondary': '#6B4A26',
            '--color-text-muted': '#8C6739',
            '--color-sidebar': '#FAF1DC',
            '--color-primary': '#3D2914',
            '--color-primary-bg': '#FCD34D',
            '--sidebar-bg': '#FAF1DC',
            '--sidebar-border': '#3D2914',
            // Brutalist
            '--bb-ink': '#3D2914',
            '--bb-paper': '#F5E6CC',
            '--bb-card': '#FAF1DC',
    ...
    },
    {
        key: 'barbie',
        name: 'Barbie Pink',
        description: 'Candy-pink paper with hot-pink stickers',
        preview: ['#FCE3F1', '#E11D74', '#FCD34D'],
        vars: {
            '--color-surface': '#FCE3F1',
            '--color-surface-card': '#FFF1F8',
            '--color-surface-hover': '#FBD2E6',
            '--color-surface-dark': '#F8B8D2',
            '--color-border': '#4A0E2A',
            '--color-border-light': '#4A0E2A',
            '--color-text': '#4A0E2A',
            '--color-text-secondary': '#7A154B',
            '--color-text-muted': '#A61B64',
            '--color-sidebar': '#FFF1F8',
            '--color-primary': '#4A0E2A',
            '--color-primary-bg': '#F472B6',
            '--sidebar-bg': '#FFF1F8',
            '--sidebar-border': '#4A0E2A',
            // Brutalist
            '--bb-ink': '#4A0E2A',
            '--bb-paper': '#FCE3F1',
            '--bb-card': '#FFF1F8',
