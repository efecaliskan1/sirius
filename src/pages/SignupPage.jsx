...
const SIGNUP_COPY = {
    en: {
        ...
        mobileGoogleNotice: 'Google sign-in for the native app still needs the mobile client IDs. For now, create your account with email and password.',
        divider: 'or',
        fullName: 'Full Name',
    ...
    tr: {
        ...
        mobileGoogleNotice: 'Mobil Google girisi icin client ID ayarlari eksik. Simdilik hesabini e-posta ve sifre ile olustur.',
        divider: 'veya',
        fullName: 'Ad soyad',
